...
class GenerateCommandCest
{
     ...
     */
    public function runTcaCreateAndDelete(BackendTester $I)
    {
     ...
     * @param BackendTester $I
     */
    public function runFrontendCreateAndDelete(BackendTester $I)
    {
     ...
     * @param BackendTester $I
     */
    public function runAllGeneratorsCreateAndDelete(BackendTester $I)
    {
